; helpofai.nsi — NSIS installer for HelpOfAi (Windows)
;
; Requirements (see https://github.com/helpofai/HelpOfAi-Cli/issues/1983):
;   - Install helpofai.exe and helpofai-tui.exe side-by-side
;   - Default to %LOCALAPPDATA%\Programs\HelpOfAi\bin
...
;        helpofai-tui.exe
;   2. Build:
;        makensis /DVERSION=1.2.3 helpofai.nsi
;   3. Output: HelpOfAiSetup.exe (in current directory)
...
!define PRODUCT_NAME "HelpOfAi"
!define PRODUCT_PUBLISHER "helpofai"
!define PRODUCT_WEB_SITE "https://github.com/helpofai/HelpOfAi-Cli"

Name "${PRODUCT_NAME} ${VERSION}"
OutFile "HelpOfAiSetup.exe"
InstallDir "$LOCALAPPDATA\Programs\HelpOfAi"
...
Section "Uninstall"
  ; Remove binaries
  Delete "$INSTDIR\bin\helpofai.exe"
  Delete "$INSTDIR\bin\helpofai-tui.exe"
