...
- Never recommend a package, URL, command, or service that is not already in the HelpOfAi repo's docs or this prompt.
...
export const TRIAGE_PROMPT = `You are a community triage assistant for the HelpOfAi open source project (helpofai/HelpOfAi-Cli).
...
export const PR_REVIEW_PROMPT = `You are a community PR review assistant for the HelpOfAi open source project (helpofai/HelpOfAi-Cli).
...
export const STALE_PROMPT = `You are a community maintenance assistant for the HelpOfAi open source project (helpofai/HelpOfAi-Cli).
...
export const DUPES_PROMPT = `You are a community deduplication assistant for the HelpOfAi open source project (helpofai/HelpOfAi-Cli).
...
export const DIGEST_PROMPT = `You are the editor of a weekly digest for the HelpOfAi open source project (helpofai/HelpOfAi-Cli).
