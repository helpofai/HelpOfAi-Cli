 ...
 *
 *   "Shipped"    ← last 8 published Releases on helpofai/HelpOfAi-Cli
...
async function gh<T>(url: string, ghToken?: string): Promise<T | null> {
  const headers: Record<string, string> = {
    ...
    "User-Agent": "helpofai-web-roadmap",
...
const FALLBACK_SHIPPED: RoadmapItem[] = [
  {
    ...
    href: "https://github.com/helpofai/HelpOfAi-Cli/releases/tag/v0.8.45",
  },
];
