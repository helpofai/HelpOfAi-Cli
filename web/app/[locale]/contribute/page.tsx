...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return {
    title: isZh ? "参与贡献 · HelpOfAi" : "Contribute · HelpOfAi",
    description: isZh
      ? "如何提交议题、发送合并请求、加入 HelpOfAi 社区。"
      : "How to file issues, send pull requests, and join the HelpOfAi community.",
  };
}
...
const stepsEn = [
  {
    ...
    cta: { label: "Open issues", href: "https://github.com/helpofai/HelpOfAi-Cli/issues" },
  },
  {
    n: "②",
    ...
    cta: { label: "Repo on GitHub", href: "https://github.com/helpofai/HelpOfAi-Cli" },
  },
  {
    n: "③",
    ...
    cta: { label: "Contributing guide", href: "https://github.com/helpofai/HelpOfAi-Cli/blob/main/CONTRIBUTING.md" },
  },
  {
    n: "④",
    title: "Open the PR",
    ...
    cta: { label: "PR template", href: "https://github.com/helpofai/HelpOfAi-Cli/blob/main/.github/PULL_REQUEST_TEMPLATE.md" },
  },
];
...
const stepsZh = [
  {
    ...
    cta: { label: "查看议题", href: "https://github.com/helpofai/HelpOfAi-Cli/issues" },
  },
  {
    n: "②",
    title: "复刻并创建分支",
    ...
    cta: { label: "GitHub 仓库", href: "https://github.com/helpofai/HelpOfAi-Cli" },
  },
  {
    n: "③",
    title: "通过本地检查",
    ...
    cta: { label: "贡献指南", href: "https://github.com/helpofai/HelpOfAi-Cli/blob/main/CONTRIBUTING.md" },
  },
  {
    n: "④",
    title: "提交 PR",
    ...
    cta: { label: "PR 模板", href: "https://github.com/helpofai/HelpOfAi-Cli/blob/main/.github/PULL_REQUEST_TEMPLATE.md" },
  },
];

const smallPatchPromptEn = `You are running inside HelpOfAi.

Improve HelpOfAi itself by finding exactly one small, reviewable friction point in the harness, docs, tests, or contributor workflow.
...
const smallPatchPromptZh = `你正在 HelpOfAi 中运行。

请改进 HelpOfAi 本身：只找一个很小、可审查的摩擦点，范围可以是智能体框架、文档、测试或贡献流程。
        ...
        <>
          ...
          <section id="small-patch-prompt" className="mx-auto max-w-[1400px] px-6 py-16 grid lg:grid-cols-12 gap-10 min-w-0">
            <div className="lg:col-span-4 min-w-0">
              ...
              <h2 className="font-display text-3xl">用 HelpOfAi 改进 HelpOfAi</h2>
              ...
              <Link href="https://github.com/helpofai/HelpOfAi-Cli/blob/main/CONTRIBUTING.md" className="inline-block mt-5 font-mono text-[0.72rem] uppercase tracking-wider text-indigo hover:underline">
                贡献指南 →
              </Link>
            </div>
          ...
          <section className="mx-auto max-w-[1400px] px-6 py-16 grid lg:grid-cols-12 gap-10">
            <div className="lg:col-span-5">
              ...
              <p className="text-ink-soft mt-4 leading-[1.9] tracking-wide">
                简而言之：做实事，别折腾元数据。完整的
                <Link href="https://github.com/helpofai/HelpOfAi-Cli/blob/main/CODE_OF_CONDUCT.md" className="body-link mx-1">行为准则</Link>
                是详细版。
              </p>
            </div>
...
{`# 在 GitHub 上 fork，然后：
git clone git@github.com:YOU/HelpOfAi
cd HelpOfAi
...
cargo test -p helpofai-state --test parity_state --locked
        ...
        <>
          ...
          <section id="small-patch-prompt" className="mx-auto max-w-[1400px] px-6 py-16 grid lg:grid-cols-12 gap-10 min-w-0">
            <div className="lg:col-span-4 min-w-0">
              ...
              <h2 className="font-display text-3xl">Use HelpOfAi on HelpOfAi</h2>
          ...
          <section className="mx-auto max-w-[1400px] px-6 py-16 grid lg:grid-cols-12 gap-10">
            <div className="lg:col-span-5">
              ...
              <p className="text-ink-soft mt-4 leading-relaxed">
                ...
                <Link href="https://github.com/helpofai/HelpOfAi-Cli/blob/main/CODE_OF_CONDUCT.md" className="body-link mx-1">Code of Conduct</Link>
                is the long version.
              </p>
            </div>
            <div className="lg:col-span-7">
