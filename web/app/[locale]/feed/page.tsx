...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return {
    title: isZh ? "动态 · HelpOfAi" : "Activity · HelpOfAi",
    description: isZh
      ? "来自 helpofai/HelpOfAi-Cli GitHub 仓库的议题、合并请求和发布的实时动态。"
      : "Live feed of issues, pull requests, and releases mirrored from the helpofai/HelpOfAi-Cli GitHub repo.",
  };
}
        ...
        <>
          <section className="mx-auto max-w-[1400px] px-6 pt-12 pb-8">
            ...
            <p className="mt-5 max-w-3xl text-ink-soft text-lg leading-[1.9] tracking-wide">
              来自{" "}
              <Link href="https://github.com/helpofai/HelpOfAi-Cli" className="body-link">helpofai/HelpOfAi-Cli</Link>
          ...
          <section className="bg-paper-deep hairline-t hairline-b">
            <div className="mx-auto max-w-[1400px] px-6 py-10 grid md:grid-cols-3 gap-6 text-center">
              <Link href="https://github.com/helpofai/HelpOfAi-Cli/issues/new/choose" className="hairline-t hairline-b hairline-l hairline-r bg-paper p-6 hover:bg-indigo hover:text-paper transition-colors">
                <div className="font-display text-xl mb-1">提交议题</div>
                <div className="font-cjk text-sm text-ink-mute">Open an issue</div>
              </Link>
              <Link href="https://github.com/helpofai/HelpOfAi-Cli/compare" className="hairline-t hairline-b hairline-l hairline-r bg-paper p-6 hover:bg-indigo hover:text-paper transition-colors">
                <div className="font-display text-xl mb-1">提交合并请求</div>
                <div className="font-cjk text-sm text-ink-mute">Open a PR</div>
              </Link>
              <Link href="https://github.com/helpofai/HelpOfAi-Cli/discussions/new" className="hairline-t hairline-b hairline-l hairline-r bg-paper p-6 hover:bg-indigo hover:text-paper transition-colors">
