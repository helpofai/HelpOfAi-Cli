...
<title>helpofai Session Export</title>
<style>
  body {{
...
<div class="footer">
  Generated by helpofai · https://github.com/helpofai/HelpOfAi-Cli
</div>
</body>
</html>"#,
    )
...
mod tests {
    ...
    fn test_render_session_html_metadata() {
        ...
        assert!(html.contains("https://github.com/helpofai/HelpOfAi-Cli"));
    }
}
