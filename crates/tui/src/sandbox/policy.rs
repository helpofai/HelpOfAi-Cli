...
pub enum SandboxPolicy {
    ...
    ///
    /// Use this when HelpOfAi is itself running inside a container,
            ...
            SandboxPolicy::WorkspaceWrite {
                ...
                roots
                    ...
                    .map(|root| {
                        ...
                        // Protect .helpofai/ and .deepseek/ directories from modification
                        let helpofai_dir = root.join(".helpofai");
                        if helpofai_dir.is_dir() {
                            read_only_subpaths.push(helpofai_dir);
                        }
