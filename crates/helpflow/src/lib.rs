//! Typed HelpFlow workflow configuration and validation.
//!
...
mod tests {
    ...
    fn workflow_ir_roundtrip() {
        ...
        let workflow = WorkflowSpec {
            ...
            description: Some("metadata-only typed HelpFlow IR".to_string()),
            budget: BudgetSpec {
                max_steps: Some(30),
        ...
        let candidate = TeacherCandidate {
            ...
            replay_results: vec![StudentReplayResult {
                ...
                required_tests: vec![StudentReplayTestResult {
                    name: "cargo test -p helpofai-helpflow".to_string(),
                    passed: true,
                }],
