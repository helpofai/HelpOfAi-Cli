...
helpofai is a coding agent with direct access to file operations, shell execution, and the network. Security disclosures are taken seriously.
...
Check the [releases page](https://github.com/helpofai/HelpOfAi-Cli/releases) for the current version.
...
- **GitHub private advisory**: [github.com/helpofai/HelpOfAi-Cli/security/advisories/new](https://github.com/helpofai/HelpOfAi-Cli/security/advisories/new)
...
- Theoretical ML-model injection attacks not demonstrated in the helpofai context
