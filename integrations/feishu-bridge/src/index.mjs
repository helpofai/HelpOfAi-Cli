...
const config = {
  ...
  runtimeUrl: (process.env.HELPOFAI_RUNTIME_URL || process.env.DEEPSEEK_RUNTIME_URL || "http://127.0.0.1:7878").replace(/\/+$/, ""),
  runtimeToken: process.env.HELPOFAI_RUNTIME_TOKEN || process.env.DEEPSEEK_RUNTIME_TOKEN || requiredEnv("HELPOFAI_RUNTIME_TOKEN"),
  workspace: process.env.HELPOFAI_WORKSPACE || process.env.DEEPSEEK_WORKSPACE || process.cwd(),
  model: process.env.HELPOFAI_MODEL || process.env.DEEPSEEK_MODEL || "auto",
  mode: process.env.HELPOFAI_MODE || process.env.DEEPSEEK_MODE || "agent",
  allowShell: parseBool(process.env.HELPOFAI_ALLOW_SHELL ?? process.env.DEEPSEEK_ALLOW_SHELL, true),
  trustMode: parseBool(process.env.HELPOFAI_TRUST_MODE ?? process.env.DEEPSEEK_TRUST_MODE, false),
  autoApprove: parseBool(process.env.HELPOFAI_AUTO_APPROVE ?? process.env.DEEPSEEK_AUTO_APPROVE, false),
  allowlist: parseList(process.env.HELPOFAI_CHAT_ALLOWLIST || process.env.DEEPSEEK_CHAT_ALLOWLIST),
  allowUnlisted: parseBool(process.env.HELPOFAI_ALLOW_UNLISTED ?? process.env.DEEPSEEK_ALLOW_UNLISTED, false),
  threadMapPath:
    process.env.FEISHU_THREAD_MAP_PATH ||
    "/var/lib/helpofai-feishu-bridge/thread-map.json",
  ...
  turnTimeoutMs: Number(process.env.HELPOFAI_TURN_TIMEOUT_MS || process.env.DEEPSEEK_TURN_TIMEOUT_MS || 900000)
};
